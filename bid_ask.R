...
# Write to CSV
write.csv(pa, "./datasets/Processed/Bid_Ask/tabac_pa.csv", row.names = F)
write.csv(pb, "./datasets/Processed/Bid_Ask/tabac_pb.csv", row.names = F)
write.csv(spread, "./datasets/Processed/Bid_Ask/tabac_spread.csv", row.names = F)